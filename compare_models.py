...
print("\n Model Performance ")
#print("------------------------------------------------")
print(f"{'Metric':<12}{'Transformer':>15}")
#print("------------------------------------------------")
print(f"Accuracy     {trans_metrics[0]*100:15.2f}%")
print(f"Precision    {trans_metrics[1]*100:15.2f}%")
print(f"Recall       {trans_metrics[2]*100:15.2f}%")
print(f"F1 Score     {trans_metrics[3]*100:15.2f}%")
#print("------------------------------------------------")
